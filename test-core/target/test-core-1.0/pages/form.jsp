    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="tab-panel.jsp" class="waves-effect waves-dark"><i class="fa fa-qrcode"></i> Tabs &
                        Panels</a>
                </li>

                <li>
                    <a href="table.jsp" class="waves-effect waves-dark"><i class="fa fa-table"></i> Responsive
                        Tables</a>
                </li>
                <li>
                            ...
                            <form class="col s12">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input disabled value="not editable maybe 注释" id="disabled" type="text"
                                               class="validate">
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <div class="input-field inline">
                                            <input id="email0" type="email" class="validate">
                                            <label for="email0" data-error="wrong" data-success="right">Email</label>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="card-content">
                            ...
                            <div class="switch">
                                ...
                                <div style="display:inline;float: right;">
                                    <input type="button" name="formButton" id="formButton" value="Submit"/>
                                </div>
                            </div>
                            <div class="clearBoth"></div>
                        </div>
                        ...
                        <div class="card-content">
                            <form class="col s12">
                                <div class="row">
                                    <div class="input-field col s6">
                                        <i class="material-icons prefix">account_circle</i>
                                        <input id="clientName" type="text" class="validate" name="clientName">
                                        <label for="clientName">Name</label>
                                    </div>
                                    <div class="input-field col s6">
                                        <i class="material-icons prefix">phone</i>
                                        <input id="clientTelephone" type="tel" class="validate" name="clientTelephone">
                                ...
                                <div class="row">
                                    <div class="input-field col s6">
                                        <i class="material-icons prefix">account_circle</i>
                                        <input id="goodsName" type="text" class="validate" name="goodsName">
                                        <label for="goodsName">Goods Name</label>
                                    </div>
                                    <div class="input-field col s6">
                                        <i class="material-icons prefix">phone</i>
                                        <input id="goodsPrice" type="tel" class="validate" name="goodsPrice">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input id="clientAddress" type="email" class="validate" name="clientAddress">
                                        <label for="clientAddress" data-error="wrong" data-success="right">Address</label>
                                    </div>
                                </div>
                            ...
                            <div class="switch">
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <div style="display:inline;float: right;">
                                    <input type="button" name="formButton" id="formButton2" value="Submit"/>
                                </div>
                            </div>
                            <div class="clearBoth"></div>
                        </div>
